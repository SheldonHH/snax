...
struct cashconfirm_action_params
{
   ...
   transactisnax::ype orig_trx_id;
};
snax::
    snax::
        // ---- ibc.snax::ontract others ----
...
snax::
    FC_REFLECT(snax::ibc::connection_status, (peer)(connecting)(syncing)(last_handshake))

        FC_REFLECT(snax::ibc::global_state_ibc_chain, (lib_depth))
            FC_REFLECT(snax::ibc::section_type, (first)(last)(np_num)(valid)(producers)(block_nums))
                FC_REFLECT(snax::ibc::block_header_state_type, (block_num)(block_id)(header)(active_schedule_id)(pending_schedule_id)(blockroot_merkle)(block_signing_key))
                    FC_REFLECT(snax::ibc::blockroot_merkle_type, (block_num)(merkle))

                        FC_REFLECT(snax::ibc::transfer_action_type, (from)(to)(quantity)(memo))
                            FC_REFLECT(snax::ibc::transfer_action_info, (contract)(from)(quantity))
                                FC_REFLECT(snax::ibc::global_state_ibc_token, (ibc_contract)(peerchain_name)(peerchain_ibc_token_contract)(max_origtrxs_table_records)(cache_cashtrxs_table_records)(max_original_trxs_per_block)(active)(lock_start_time)(lock_minutes))
                                    FC_REFLECT(snax::ibc::global_mutable_ibc_token, (cash_seq_num)(last_finished_trx_block_time_slot)(current_block_time_slot)(current_block_trxs)(origtrxs_tb_next_id))
                                        FC_REFLECT(snax::ibc::original_trx_info, (id)(block_time_slot)(trx_id)(action))
                                            FC_REFLECT(snax::ibc::cash_trx_info, (seq_num)(block_time_slot)(trx_id)(action)(orig_trx_id)(orig_trx_block_num))
                                                FC_REFLECT(snax::ibc::cash_action_params, (seq_num)(orig_trx_block_num)(orig_trx_packed_trx_receipt)(orig_trx_merkle_path)(orig_trx_id)(to)(quantity)(memo)(relay))
                                                    FC_REFLECT(snax::ibc::cashconfirm_action_params, (cash_trx_block_num)(cash_trx_packed_trx_receipt)(cash_trx_merkle_path)(cash_trx_id)(orig_trx_id))
                                                        FC_REFLECT(snax::ibc::memo_info_type, (receiver)(chain)(notes))
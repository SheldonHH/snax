...
struct lwc_section_type
{
   ...
   {
      return first_num == b.first_num && last_num == b.last_num && lib_num == b.lib_num && first_id == b.first_id && last_id == b.last_id && lib_id == b.lib_id && valid == b.valid;
   }
   bool operator!=(lwc_section_type b)
   {
      return !(*this == b);
...
struct ibc_trx_rich_info
{
   ...
   uint32_t snax::um;
   transactisnax::ype trx_id;
   std::vector<char> packed_trx_receipt;
   std::vectsnax::st_type > merkle_path;
};
snax::
    snax::
        struct ibc_tsnax::uest_message
{
   snax::
       ibc_trxs_snax::_message() : table(), range() {}
   name tablsnax::
       range_typsnax::;
};
...
FC_REFLECT(snax::ibc::handshake_message,
...
FC_REFLECT(snax::ibc::go_away_message, (reason)(node_id))
FC_REFLECT(snax::ibc::time_message, (org)(rec)(xmt)(dst))

FC_REFLECT(snax::ibc::lwc_section_type, (first_num)(last_num)(lib_num)(first_id)(last_id)(lib_id)(valid))
FC_REFLECT(snax::ibc::ibc_heartbeat_message, (ibc_chain_state)(ibc_token_state)(lwcls)(origtrxs_table_id_range)(cashtrxs_table_seq_num_range)(new_producers_block_num))
FC_REFLECT(snax::ibc::lwc_init_message, (header)(active_schedule)(blockroot_merkle))
FC_REFLECT(snax::ibc::lwc_section_request_message, (start_block_num)(end_block_num))
FC_REFLECT(snax::ibc::lwc_section_data_message, (headers)(blockroot_merkle))
FC_REFLECT(snax::ibc::ibc_trx_rich_info, (table_id)(block_num)(trx_id)(packed_trx_receipt)(merkle_path))
FC_REFLECT(snax::ibc::ibc_trxs_request_message, (table)(range))
FC_REFLECT(snax::ibc::ibc_trxs_data_message, (table)(trxs_rich_info))
